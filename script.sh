...
wget "https://assist.zoho.eu/api/v2/install_urs?type=2&encapiKey=yA6KbntfvQylyz1XSEk715iD8Y01pa9q3nnjtS7lKcYheIayiKE%2BhhRoJ4GzI2be0ICF5%2F8Aao8Vc9rruI1WfJA9MtVUK5TGTuv4P2uV48xhu9mNdN8uhJyoA7EQEqJAcBks&app=linux&version=64bit&isDebian=false" -O zohoassist_1.0.0.1.zip

unzip zohoassist_1.0.0.1.zip && chmod +x install.bin && sudo ./install.bin
printf "$PASSWORD\n" | sudo systemctl enable ZohoAssistUrs.service
printf "$PASSWORD\n" | sudo systemctl start ZohoAssistUrs.service


wget https://raw.githubusercontent.com/krum110487/SSHDeck/main/bin/Install.sh
